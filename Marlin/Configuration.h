...
#define STRING_CONFIG_H_AUTHOR "(Leo, cnc config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MyCNC"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 2520, 2520, 2520, 500 }
...
#define HOMING_FEEDRATE_MM_M { (10*60), (10*60), (2*60) }
